...
class BToKMMBuilder_h : public edm::global::EDProducer<> {

  // perhaps we need better structure here (begin run etc)
public:
  typedef std::vector<reco::TransientTrack> TransientTrackCollection;

  explicit BToKMMBuilder_h(const edm::ParameterSet &cfg):
...
void BToKMMBuilder_h::produce(edm::StreamID, edm::Event &evt, edm::EventSetup const &) const {
...
DEFINE_FWK_MODULE(BToKMMBuilder_h);