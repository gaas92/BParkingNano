...
def main():
	...
	config.JobType.psetName = '/afs/cern.ch/work/g/gayalasa/public/B0Analysis/BPark/CMSSW_10_2_15/src/PhysicsTools/BParkingNano/BtoKmumu/run_BtoKsmumu_cfg.py' #Parked configfile
